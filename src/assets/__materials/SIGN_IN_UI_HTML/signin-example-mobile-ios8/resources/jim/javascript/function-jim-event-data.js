...
(function (window, undefined) {
    ...
    function getInstances($target) {
        return $target.find(".datarow, .gridcell")
            .filter(function (i, e) {
                return $($(e).closest(".datagrid, .datalist")).attr("id") == $target.attr("id");
            });
    }
    ...
    jQuery.extend(jimEvent.fn, {
        ...
        "jimUpdateData": function (args, callback) {
            var self = this, datamaster, instances, instance, i, iLen, j, jLen, variable, records, record, value,
                $dataViews, g, gLen, k, kLen, $datarows, field, $field;
            if (args && args.fields) {
                /* update data */
        ...
        "jimDeleteData": function (args, callback) {
            var self = this, datamaster, $grid, $gridCell, variable, instances, removeInstances, removeInstance,
                removeID, i, iLen, j, id;
            if (args) {
        ...
        "jimFilterData": function (args) {
            var self = this, filteredInstances = [], instances, i, len, result, searchTokens, searchExpression, search,
                property;
            if (args) {
                instances = jimUtil.toArray(self.evaluateExpression(args));

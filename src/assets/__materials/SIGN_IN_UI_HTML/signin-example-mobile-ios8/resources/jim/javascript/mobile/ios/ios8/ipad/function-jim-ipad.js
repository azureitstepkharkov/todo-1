        ...
        jQuery(controller.dateKey + " .da_days").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    ...
                    jQuery("#jim-ipad-da_options_big .da_days").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-da_options .da_days").animate({
        ...
        jQuery(controller.dateKey + " .da_months").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-da_options_big .da_months").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-da_options .da_months").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.dateKey + " .da_years").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-da_options_big .da_years").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-da_options .da_years").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.timeKey + " .ti_hours").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-ti_options_big .ti_hours").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-ti_options .ti_hours").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.timeKey + " .ti_minutes").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-ti_options_big .ti_minutes").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-ti_options .ti_minutes").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
    ...
    function bindTimePeriods() {
        jQuery(controller.timeKey + " .ti_periods").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((topPos - ddTop) > 14) {
                    jQuery("#jim-ipad-ti_options_big .ti_periods").animate({
                        'top': topPosBig - 30 + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-ti_options .ti_periods").animate({
                        'top': topPos - 30 + 'px',
                        queue: false
                    }, function () {
                        setTimeValue(input);
        ...
        jQuery(controller.datetimeKey + " .dt_date").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-dt_options_big .dt_date").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-dt_options .dt_date").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.datetimeKey + " .dt_hours").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-dt_options_big .dt_hours").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-dt_options .dt_hours").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.datetimeKey + " .dt_minutes").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-ipad-dt_options_big .dt_minutes").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-dt_options .dt_minutes").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
    ...
    function bindDateTimePeriods() {
        jQuery(controller.datetimeKey + " .dt_periods").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((topPos - ddTop) > 14) {
                    jQuery("#jim-ipad-dt_options_big .dt_periods").animate({
                        'top': topPosBig - 30 + 'px',
                        queue: false
                    });
                    jQuery("#jim-ipad-dt_options .dt_periods").animate({
                        'top': topPos - 30 + 'px',
                        queue: false
                    }, function () {
                        setDateTimeValue(input);

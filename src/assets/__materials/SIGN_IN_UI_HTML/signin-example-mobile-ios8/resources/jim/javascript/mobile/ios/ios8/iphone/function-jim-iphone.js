...
(function (window, undefined) {
    ...
    function changeValueByKeyboard($target, newKey) {
        ...
        switch (type) {
            ...
            case itemType.password:
                ...
                else $target.find("input").val(jimUtil.fromHTML(action.newValue)).caret({
                    start: startPos + action.caretDespl,
                    end: startPos + action.caretDespl
                });
                break;
            case itemType.textarea:
                ...
                else $target.find("textarea").val(jimUtil.fromHTML(action.newValue)).caret({
                    start: startPos + action.caretDespl,
                    end: startPos + action.caretDespl
                });
                break;
        }
        input.closest(".firer").trigger("keyup.jim", [{
            "preventTrigger": true,
            "altKey": false,
            "ctrlKey": false,
            "shiftKey": false,
            "which": (newKey.startsWith("return")) ? 13 : newKey.toLowerCase().charCodeAt(0) - 32
        }]);
    }
    ...
    function bindDropDown() {
        jQuery(controller.dropdownKey).on("mouseup", function (event, data) {
            ...
            if (dragStart) {
                ...
                jQuery(controller.dropdownKey + " #jim-iphone-dd_options .dd_options").animate({
                    "top": topPos + "px",
                    queue: false
                });
                jQuery(controller.dropdownKey + " #jim-iphone-dd_options_big .dd_options").animate({
                    "top": topPos - comPos - 1 + "px",
                    queue: false
                });
                ...
                if (key) {
                    ...
                    switch (key) {
                        ...
                        case "options":
                            ...
                            jQuery(controller.dropdownKey + " #jim-iphone-dd_options .dd_options").animate({
                                "top": 88 - ($target.position().top * zoom) + "px",
                                queue: false
                            });
                            jQuery(controller.dropdownKey + " #jim-iphone-dd_options_big .dd_options").animate({
                                "top": 0 - ($target.position().top * zoom) + "px",
                                queue: false
                            });
                            break;
        ...
        jQuery(controller.dropdownKey).on("drag", function (event, data) {
            if (dragStart) {
                ...
                if (posY < offset.top) {
                    ...
                    jQuery(controller.dropdownKey + " #jim-iphone-dd_options .dd_options").animate({
                        "top": -(childHeight * (ddSize - 4)) - 16 + "px",
                        queue: false
                    });
                    jQuery(controller.dropdownKey + " #jim-iphone-dd_options_big .dd_options").animate({
                        "top": -(childHeight * (ddSize - 4)) - 16 - 82 + "px",
                        queue: false
                    });
                    dragStart = false;
    ...
    function fillDropDownOptions($target) {
        ...
        switch (type) {
            ...
            case itemType.nativedropdown:
                ...
                var childHeight = parseInt(jQuery(".options").height()) + parseInt(jQuery(".options").css('padding-top'));
                jQuery(controller.dropdownKey + " #jim-iphone-dd_options .dd_options").animate({
                    "top": -(selectedPos * childHeight) + 88 + "px",
                    queue: false
                });
                jQuery(controller.dropdownKey + " #jim-iphone-dd_options_big .dd_options").animate({
                    "top": -(selectedPos * childHeight) + 0 + "px",
                    queue: false
                });
    ...
    function createDate() {
        ...
        jQuery(controller.dateKey + ' .da_months').draggable({
            ...
            drag: function (evt, ui) {
                correctDragDateWithZoom(evt, ui)
            }
        });
        ...
        jQuery(controller.dateKey + " .da_days").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    ...
                    jQuery("#jim-iphone-da_options_big .da_days").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-da_options .da_days").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
    ...
    function moveDigits(disabledSelected) {
        ...
        var topPos = 210, topPosBig = 302;
        jQuery("#jim-iphone-da_options_big .da_days").animate({
            'top': -topPosBig + (29 * disabledDays) + 'px',
            queue: false
        });
        jQuery("#jim-iphone-da_options .da_days").animate({
            'top': -topPos + (29 * disabledDays) + 'px',
            queue: false
        }, function () {
        ...
        jQuery(controller.dateKey + " .da_months").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-da_options_big .da_months").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-da_options .da_months").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.dateKey + " .da_years").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-da_options_big .da_years").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-da_options .da_years").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.timeKey + " .ti_hours").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-ti_options_big .ti_hours").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-ti_options .ti_hours").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.timeKey + " .ti_minutes").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-ti_options_big .ti_minutes").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-ti_options .ti_minutes").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
    ...
    function bindTimePeriods() {
        jQuery(controller.timeKey + " .ti_periods").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((topPos - ddTop) > 14) {
                    jQuery("#jim-iphone-ti_options_big .ti_periods").animate({
                        'top': topPosBig - 30 + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-ti_options .ti_periods").animate({
                        'top': topPos - 30 + 'px',
                        queue: false
                    }, function () {
                        setTimeValue(input);
        ...
        jQuery(controller.datetimeKey + " .dt_date").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-dt_options_big .dt_date").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-dt_options .dt_date").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.datetimeKey + " .dt_hours").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-dt_options_big .dt_hours").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-dt_options .dt_hours").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
        ...
        jQuery(controller.datetimeKey + " .dt_minutes").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((ddTop + topPos) > 14) {
                    var offset = -topPos - ddTop - 14;
                    var despl = parseInt(offset / 29);
                    jQuery("#jim-iphone-dt_options_big .dt_minutes").animate({
                        'top': -topPosBig - (despl * 29) + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-dt_options .dt_minutes").animate({
                        'top': -topPos - (despl * 29) + 'px',
                        queue: false
                    }, function () {
    ...
    function bindDateTimePeriods() {
        jQuery(controller.datetimeKey + " .dt_periods").on("mouseup", function (event, data) {
            if (dragStart) {
                ...
                if ((topPos - ddTop) > 14) {
                    jQuery("#jim-iphone-dt_options_big .dt_periods").animate({
                        'top': topPosBig - 30 + 'px',
                        queue: false
                    });
                    jQuery("#jim-iphone-dt_options .dt_periods").animate({
                        'top': topPos - 30 + 'px',
                        queue: false
                    }, function () {
                        setDateTimeValue(input);

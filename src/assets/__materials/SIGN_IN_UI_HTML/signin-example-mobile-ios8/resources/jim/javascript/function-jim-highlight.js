...
(function (window, undefined) {
    ...
    function highLight(value, fired) {
        ...
        elements = elements.not(':hidden').not('.shapewrapper, path, ellipse').filter(function (index, element) {
            return $(element).closest(".shapewrapper").length == 0;
        });
